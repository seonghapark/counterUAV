...
for i in range(len(file_list) - 1):
    ...
    file_name = file_list[i].split('.')
    file_name = file_name[0]
    wavfile.write("C://Users//승윤//Desktop//purdue//연구자료//extractwav//binary_convert_wav//"+ file_name + ".wav", 5862, audio.T.astype(np.int16))
    print(i + 1, '번째 파일 완료')
...
label_path_dir ='C://Users//승윤//Desktop//purdue//연구자료//extractwav//rawdata//rnn_label.txt'
...
np.save('C://Users//승윤//Desktop//purdue//연구자료//extractwav//label_list.npy',c)
print('save')
b=np.array(time_list)
np.save('C://Users//승윤//Desktop//purdue//연구자료//extractwav//time_list.npy',b)
print('save')
