...
def main():
    ...
    #src_path = sys.argv[1]
    src_path = '20181009_100023_binary.txt'
    src_basename = os.path.basename(src_path)
    src_basename = 'C:/Users/승윤/Desktop/counterUAV/raw_data/data_process'
    try:
        file = open(src_path, "rb")
        read_data = file.read()
        filename = 'C:/Users/승윤/Desktop/counterUAV/raw_data/data_process/20181009_100023_binary' # get file name
