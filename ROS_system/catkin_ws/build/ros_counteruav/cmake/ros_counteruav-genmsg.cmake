...
message(STATUS "ros_counteruav: 1 messages, 0 services")

set(MSG_I_FLAGS "-Iros_counteruav:/home/jhjeong/project/counterUAV/ROS_system/catkin_ws/src/ros_counteruav/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/jhjeong/project/counterUAV/ROS_system/catkin_ws/src/ros_counteruav/msg/fakedata.msg" NAME_WE)
add_custom_target(_ros_counteruav_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ros_counteruav" "/home/jhjeong/project/counterUAV/ROS_system/catkin_ws/src/ros_counteruav/msg/fakedata.msg" ""
)
...
_generate_msg_cpp(ros_counteruav
  "/home/jhjeong/project/counterUAV/ROS_system/catkin_ws/src/ros_counteruav/msg/fakedata.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ros_counteruav)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ros_counteruav\")")
  # install generated code
  install(
