...
for i in range(inputnodecount):
	...
	data_dict[nodeNUM[i]]["SIR"] = []
	data_dict[nodeNUM[i]]["SUV"] = []
	data_dict[nodeNUM[i]]["SVL"] = []

	### sound level sensor
	data_dict[nodeNUM[i]]["spv"] = []

	### magnetic field
	data_dict[nodeNUM[i]]["magx"] = []
	data_dict[nodeNUM[i]]["magy"] = []
	data_dict[nodeNUM[i]]["magz"] = []
	data_dict[nodeNUM[i]]["magrms"] = []

	### accelerometer
	data_dict[nodeNUM[i]]["accx"] = []
	data_dict[nodeNUM[i]]["accy"] = []
	data_dict[nodeNUM[i]]["accz"] = []

	### chemical sensor
	data_dict[nodeNUM[i]]["irr"] = []
	data_dict[nodeNUM[i]]["iaq"] = []
	data_dict[nodeNUM[i]]["no2"] = []
	data_dict[nodeNUM[i]]["so2"] = []
	data_dict[nodeNUM[i]]["h2s"] = []
	data_dict[nodeNUM[i]]["o3"] = []
	data_dict[nodeNUM[i]]["co"] = []

	### time
	data_dict[nodeNUM[i]]["time"] = []
	time = 0
