...
if __name__ == '__main__':
	...
	parser.add_argument('--ds', dest='start_day', nargs=1, help='Start date from today, 0 means start 0 day before today: today')
	parser.add_argument('--de', dest='end_day', nargs=1, help='End date from today, 1 means one day before the start day: yesterday')
